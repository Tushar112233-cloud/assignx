...
class WalletRewardsData {
  ...
  String? get nextTierLabel {
    ...
    return RewardTier.values[currentTier.index + 1].label;
  }
}
...
/// Wallet rewards display widget using the Coffee Bean flat design system.
///
/// Features:
/// - Points balance display with coin icon in a tinted circle
      ...
      child: Column(
        ...
        children: [
          ...
          if (_data.currentTier != RewardTier.platinum)
            Text(
              '${_data.pointsToNextTier} points to ${_data.nextTierLabel}',
              style: AppTextStyles.caption.copyWith(
                fontSize: 11,
                color: AppColors.textTertiary,
              ),
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Earn points by completing projects and referring friends',
                    style: AppTextStyles.caption.copyWith(
                      fontSize: 11,
                ...
                children: [
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 8),
                      Text(
                        '${_data.currentTier.label} Benefits',
...
/// Tier progress bar widget using flat Coffee Bean design.
...
/// Redemption option tile widget using flat Coffee Bean design.
