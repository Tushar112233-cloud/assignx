...
/// Stub: no backend endpoint yet. Returns [] until API is implemented.
final studyGroupsProvider =
    FutureProvider.autoDispose<List<StudyGroup>>((ref) async {
  // TODO: fetch from GET /api/study-groups once the endpoint exists.
  return [];
});
...
final sharedResourcesProvider =
  ...
  // TODO: fetch from GET /api/resources once the endpoint exists.
  return [];
});
...
final connectTutorsProvider =
  ...
  // TODO: fetch from GET /api/tutors once the endpoint exists.
  return [];
});
...
final userStudyGroupsProvider =
    FutureProvider.autoDispose<List<StudyGroup>>((ref) async {
  // TODO: fetch from GET /api/study-groups/mine once the endpoint exists.
  return [];
});
...
final savedResourcesProvider =
    FutureProvider.autoDispose<List<SharedResource>>((ref) async {
  // TODO: fetch from GET /api/resources/saved once the endpoint exists.
  return [];
});

/// Available subjects for filtering, fetched from the subjects API.
final connectSubjectsProvider = FutureProvider<List<String>>((ref) async {
