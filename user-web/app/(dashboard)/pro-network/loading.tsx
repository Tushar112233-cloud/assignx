...
/**
 * Loading state for Pro Network pages
 * Displays skeleton placeholders matching the page layout
 */
export default function ProNetworkLoading() {
  return (
    <div className="min-h-[calc(100vh-3.5rem)] bg-background">
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-6 space-y-6">
        {/* Hero skeleton */}
        <div className="h-48 md:h-56 rounded-2xl bg-gradient-to-br from-blue-200 to-indigo-200 dark:from-blue-900/30 dark:to-indigo-900/30 animate-pulse" />
