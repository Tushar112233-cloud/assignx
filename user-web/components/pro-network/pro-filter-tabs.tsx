...
/**
 * ProFilterTabs - Horizontally scrollable category filter tabs
 * Filters the pro network post feed by category
 */
...
import { PRO_NETWORK_CATEGORIES, type ProNetworkCategory } from "@/types/pro-network";

interface ProFilterTabsProps {
  /** Currently selected category */
  activeCategory: ProNetworkCategory;
  /** Callback when a category is selected */
  onCategoryChange: (category: ProNetworkCategory) => void;
}

export function ProFilterTabs({
  activeCategory,
  onCategoryChange,
}: ProFilterTabsProps) {
  ...
  return (
    <div className="relative group">
      ...
      >
        {PRO_NETWORK_CATEGORIES.map((category) => {
