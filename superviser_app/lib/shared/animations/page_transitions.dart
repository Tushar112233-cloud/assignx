...
///
/// Provides three transition styles matching the supervisor app design system:
...
/// (e.g., project list -> project detail -> chat).
///
/// Example:
/// ```dart
/// GoRoute(
...
/// screens that feel like overlays or detail modals (e.g., ticket detail,
/// create post).
///
/// Example:
/// ```dart
...
///     key: state.pageKey,
///     child: TicketDetailScreen(ticketId: state.pathParameters['ticketId']!),
///   ),
/// ),
/// ```
