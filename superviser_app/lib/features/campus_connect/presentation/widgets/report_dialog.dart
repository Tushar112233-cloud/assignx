...
enum ReportReason {
  scam('scam', 'Scam or Fraud',
      'Suspicious activity, fake listings, or fraud attempts'),
...
class _ReportBottomSheetState extends State<ReportBottomSheet> {
  ...
  Future<void> _submitReport() async {
    if (_selectedReason == null) {
      setState(() => _error = 'Please select a reason for your report');
      return;
    }
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: AppColors.surfaceVariantLight.withAlpha(128),
              border: Border(
    ...
    return Padding(
      ...
      child: Material(
        color: isSelected
            ...
            : AppColors.surfaceVariantLight.withAlpha(128),
        borderRadius: BorderRadius.circular(12),
        child: InkWell(
          onTap: () {
