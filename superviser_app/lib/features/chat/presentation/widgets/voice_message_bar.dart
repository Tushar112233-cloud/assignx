  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: progressForegroundColor.withValues(alpha: 0.35)),
      ),
      child: Row(
        children: [
          Container(
            ...
            child: Material(
              ...
              child: InkWell(
                ...
                child: Icon(
                  isBusy ? Icons.hourglass_top_rounded : (playing ? Icons.pause_rounded : Icons.play_arrow_rounded),
                  size: 24,
                  color: playIconColor,
                ),
              ),
            ...
            child: StreamBuilder<Duration>(
              ...
              builder: (context, _) {
                ...
                final frac = dur.inMilliseconds > 0
                    ...
                    : 0.0;
                final label = isThis && dur > Duration.zero
...
class _WaveformBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final playedBars = (heights.length * progress.clamp(0.0, 1.0)).floor();
    return Row(
