  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-50">
      <div className="w-full max-w-sm mx-auto px-6">
        <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm text-center space-y-5">
          {status === "verifying" && (
            <>
              <Loader2 className="h-12 w-12 animate-spin text-[#F97316] mx-auto" />
              <p className="text-sm text-gray-600 font-medium">Verifying your sign-in link...</p>
            </>
          )}
          ...
          {status === "success" && (
            <>
              ...
              <div>
                <h1 className="text-xl font-bold text-[#1C1C1C]">Email verified!</h1>
          ...
          {status === "error" && (
            <>
              ...
              <div>
                <h1 className="text-xl font-bold text-[#1C1C1C]">Verification failed</h1>
                <p className="mt-2 text-sm text-gray-500 leading-relaxed">{message}</p>
              </div>
            </>
          )}
