...
import { AlertCircle, RefreshCw, Home, FolderKanban } from 'lucide-react'
import { Button } from '@/components/ui/button'
import { Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from '@/components/ui/card'

/**
 * Error boundary for the Projects page
 * Handles errors during project list fetching and rendering
 *
    ...
    <div className="min-h-[60vh] flex items-center justify-center p-4">
      <Card className="max-w-md w-full">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            {error.message || 'Failed to load projects. This could be due to a network issue or server error.'}
          </CardDescription>
        </CardHeader>
