 ...
 * Handles errors during profile data fetching and settings rendering
 *
    ...
    <div className="min-h-[60vh] flex items-center justify-center p-4">
      <Card className="max-w-md w-full">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            {error.message || 'Failed to load profile data. This could be due to a network issue or authentication error.'}
          </CardDescription>
        </CardHeader>
