...
// Helper classes _LabelValue and _ExperienceOption are now imported from
// reference_data.dart as LabelValue and ExperienceOption.
...
class _RegisterScreenState extends ConsumerState<RegisterScreen> {
  ...
  String _labelFor(List<LabelValue> list, String? value) {
    if (value == null) return '';
    return list.firstWhere((e) => e.value == value, orElse: () => LabelValue(value, value)).label;
  }
              ...
              return Expanded(
                child: Padding(
                  padding: EdgeInsets.only(
                    right: level.value != experienceLevels.last.value
                        ? AppSpacing.sm
                        : 0,
                  ),
      ...
      children: [
        ...
        _buildReviewSection(
          ...
          rows: [
            _ReviewRow(
              'Qualification',
              _labelFor(qualificationOptions, _qualification),
            ),
            _ReviewRow(
              'Experience',
              experienceLevels
        ...
        _buildReviewSection(
          ...
          title: 'Bank Details',
          rows: [
            _ReviewRow('Bank', _labelFor(indianBanks, _bankName)),
            _ReviewRow(
              'Account',
