...
class _ProfileSetupScreenState extends ConsumerState<ProfileSetupScreen> {
  ...
  // Qualifications are imported from reference_data.dart (qualificationOptions).
            ...
            child: Column(
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: qualificationOptions.map((q) {
                    return DropdownMenuItem(value: q.label, child: Text(q.label));
                  }).toList(),
                  onChanged: (value) {
