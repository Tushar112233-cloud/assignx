/// Report bottom sheet dialog for community posts.
library;
...
enum ReportReason {
  scam('scam', 'Scam or Fraud',
      'Suspicious activity, fake posts, or fraud attempts'),
  inappropriate('inappropriate', 'Inappropriate Content',
      'Offensive, harmful, or violates community guidelines'),
  inaccurate('inaccurate', 'Inaccurate Information',
      'Misleading, false, or outdated information'),
  spam('spam', 'Spam',
      'Repetitive posts, promotional content, or irrelevant'),
...
/// Bottom sheet widget for reporting posts.
...
class _ReportBottomSheetState extends State<ReportBottomSheet> {
  ...
  Future<void> _submitReport() async {
    ...
    try {
      await ApiClient.post('/community/pro-network/posts/${widget.postId}/report', {
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                ...ReportReason.values.map(_buildReasonOption),
