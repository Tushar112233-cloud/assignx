...
class ReviewModel {
  ...
  /// Avatar URL of the reviewer, if available.
  final String? reviewerAvatarUrl;

  /// Overall rating given (0.0 to 5.0).
  ///
  /// Typically displayed as stars.
  final double rating;

  /// Quality rating (0.0 to 5.0).
  final double? qualityRating;

  /// Timeliness rating (0.0 to 5.0).
  final double? timelinessRating;

  /// Communication rating (0.0 to 5.0).
