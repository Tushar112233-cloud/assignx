...
///
/// This model contains doer-specific fields including
/// qualifications, experience, bank details, performance statistics, and
/// moderation flags. JWT `sub` = Doer `_id`.
///
/// ## JSON Structure
///
/// ```json
...
class DoerModel {
  ...
  ///
  /// UUID generated by the database. JWT `sub` matches this ID.
  final String id;
  ...
  /// @returns A map suitable for database insert operation.
  ///
  /// ## Example
  ///
  /// ```dart
  ...
  @override
  String toString() {
    return 'DoerModel(id: $id, qualification: $qualification, isActivated: $isActivated)';
  }
}
